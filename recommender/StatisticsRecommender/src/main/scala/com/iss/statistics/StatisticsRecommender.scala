...
object StatisticsRecommender {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 1. 历史热门书籍，按照评分个数统计，productId，count
    ...
    // 2. 近期热门书籍，把时间戳转换成yyyyMM格式进行评分个数统计，最终得到productId, count, yearmonth
    // 创建一个日期格式化工具
    ...
    // 3. 优质书籍统计，书籍的平均评分，productId，avg
