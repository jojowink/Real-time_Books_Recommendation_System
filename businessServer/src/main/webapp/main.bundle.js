...
module.exports = "<div>\n  <h3><span class=\"icon-uniE18E\" aria-hidden=\"true\" style=\"font-size: 20px;\"></span> real time recommendations</h3>\n  <p class=\"descri\">guess you like <a [routerLink]=\"['/explore', { type: 'guess' }]\" >more...</a></p>\n  <div class=\"grid grid-pad\">\n    <div class=\"row\">\n      <div class=\"col-lg-2 col-md-2\" *ngFor=\"let streamProduct of streamProducts\"><app-thumbnail [product]=\"streamProduct\"></app-thumbnail></div>\n    </div>\n  </div>\n\n  <h3><span class=\"glyphicon glyphicon-heart\" aria-hidden=\"true\" style=\"font-size: 20px;\"></span> off-line recommendations</h3>\n  <p class=\"descri\">Recently added books <a [routerLink]=\"['/explore', { type: 'offline' }]\" >more...</a></p>\n  <div class=\"grid grid-pad\">\n    <div class=\"row\">\n      <div class=\"col-lg-2 col-md-2\" *ngFor=\"let offlineProduct of offlineProducts\"><app-thumbnail [product]=\"offlineProduct\"></app-thumbnail></div>\n    </div>\n  </div>\n\n  <h3><span class=\"icon-whatshot\" aria-hidden=\"true\" style=\"font-size: 20px;\"></span> hot recommendations</h3>\n  <p class=\"descri\">The book recommendation system recommended these books <a [routerLink]=\"['/explore', { type: 'hot' }]\" >more...</a></p>\n  <div class=\"grid grid-pad\">\n    <div class=\"row\">\n      <div class=\"col-lg-2 col-md-2\" *ngFor=\"let hotProduct of hotProducts\">\n        <app-thumbnail [product]=\"hotProduct\"></app-thumbnail>\n      </div>\n    </div>\n  </div>\n\n  <h3><span class=\"glyphicon glyphicon-star\" aria-hidden=\"true\" style=\"font-size: 20px;\"></span> most rated</h3>\n  <p class=\"descri\">To improve the accuracy of the recommendation system, the more scores the better <a [routerLink]=\"['/explore', { type: 'rate' }]\" >more...</a></p>\n  <div class=\"grid grid-pad\">\n    <div class=\"row\">\n      <div class=\"col-lg-2 col-md-2\" *ngFor=\"let rateMoreProduct of rateMoreProducts\"><app-thumbnail [product]=\"rateMoreProduct\"></app-thumbnail></div>\n    </div>\n  </div>\n\n</div>\n"
...
module.exports = "<div class=\"row logindiv\">\n  <div class=\"col-md-6 col-lg-offset-3\">\n    <h3 style=\"margin-bottom: 40px\">Book recommendation system login</h3>\n    <form (ngSubmit)=\"login()\" #loginForm=\"ngForm\">\n      <div class=\"form-group\">\n        <label for=\"exampleInputEmail1\">login email</label>\n        <input type=\"email\" class=\"form-control\" id=\"exampleInputEmail1\" placeholder=\"email\" [(ngModel)]=\"user.username\" name=\"username\" required>\n      </div>\n      <div class=\"form-group\">\n        <label for=\"exampleInputPassword1\">login password</label>\n        <input type=\"password\" class=\"form-control\" id=\"exampleInputPassword1\" placeholder=\"login password\" [(ngModel)]=\"user.password\" name=\"password\" required>\n      </div>\n      <div class=\"checkbox\">\n        <label>\n          <input type=\"checkbox\"> remember me\n        </label>\n      </div>\n      <button type=\"submit\" class=\"btn btn-default\" [disabled]=\"!loginForm.form.valid\"><span class=\"glyphicon glyphicon-upload\" aria-hidden=\"true\"></span> login</button>\n\n      <div class=\"alert alert-danger\" role=\"alert\" [hidden] = \"loginService.data['success']\">\n        <strong>fail！</strong> {{loginService.data['message']}}\n      </div>\n    </form>\n    <h5><a routerLink=\"/register\" routerLinkActive=\"active\">user sign in</a> | <a routerLink=\"/forgot\" routerLinkActive=\"active\">forgot password</a></h5>\n  </div>\n\n</div>\n\n"
...
var LoginService = (function () {
    ...
    LoginService.prototype.login = function (user) {
        ...
        this.http
            ...
            _this.data['message'] = 'server error！';
        });
    };
